...
def detectWear(imgName):
	...
	gray = cv2.bilateralFilter(gray,9,40,80)
...
wirePhotos = pullAllImages()
	
for curr in wirePhotos:
	print(curr[7:])
	i = detectWear(curr)
	if i == 0 :
		with open("defects.txt", 'a') as filetowrite:
			filetowrite.write(curr[7:])
